 ...
 * 
 * Usage: java InvokeStaticInstrumenter TestInvoke
 */
package soot.example.call_instrument;
...
public class InvokeStaticInstrumenter extends BodyTransformer {
	...
	static {
		counterClass = Scene.v().loadClassAndSupport("examples.call_instrument.MyCounter");
	...
	public static void main(String[] args) {
		 ...
		 */
		//注意classpath是个很难缠的问题，这里直接设定eclipse的库来定位TestInvoke
		String newArgs[]={"-f","class",/*"jimple"*/"TestInvoke"};
